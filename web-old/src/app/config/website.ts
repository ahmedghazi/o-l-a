export default {
  ...
  title: "Olivier Lellouche Design Workshop", // Navigation and Site Title
  titleAlt: "OLLDW", // Title for JSONLD
  description: "desc here",
  headline: "", // Headline for schema.org JSONLD
  url: "http://olivierlellouche.com", // Domain of your site. No trailing slash!
